    ...
    <main className="pr-page">
      ...
      <div className="app-container">
        ...
        <header className="pr-header">
          <span className="pr-header__chip">Guardados</span>
          <h1 className="pr-header__title">Mis favoritos</h1>
        ...
        {isEmpty && (
          <div className="pr-empty">
            ...
            <h2 className="pr-empty__title">Aún no tienes favoritos</h2>
            ...
            <button className="pr-empty__btn" onClick={() => navigate("/products")}>
              Explorar productos
            ...
            <div className="pr-filters">
              <div className="pr-filters__controls">
                <label className="pr-toggle">
                  ...
                  <span className="pr-toggle__label">Solo disponibles</span>
                </label>
